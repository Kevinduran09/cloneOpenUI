...
async def ldap_auth(request: Request, response: Response, form_data: LdapForm):
    ...
    try:
        ...
        log.error(f"An error occurred on TSL: {str(e)}")
...
async def update_ldap_server(
    ...
    requried_fields = ['label','host', 'attribute_for_username', 'app_dn','app_dn_password','search_base', 'use_tls']
    for key in requried_fields:
